 ...
 */
function superdiod_html_head_alter(&$head_elements) {
 ...
 */
function superdiod_preprocess_search_block_form(&$vars) {
 ...
 */
function superdiod_preprocess_html(&$vars) {
    $vars['doctype'] = '<!DOCTYPE html>' . "\n";
}



function superdiod_preprocess_page (&$variables) {
 ...
 */
function superdiod_breadcrumb($vars) {
...
function superdiod_preprocess_node(&$vars) {
