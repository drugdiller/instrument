    			    ...
    			    <h1 class="title" id="page-title"><?php print $title; ?></h1>
						    ...
						    <nav id="navigation">
								<div class="section">
									...
									<div class="phone-icon"><img src="/<?php print path_to_theme() ?>/img/phone-icon.gif"></div><div class="phone-text">812 923-93-87</div>
									<div class="clear"></div>
									 <div class="pdf"><a href="/sites/default/files/catalog.pdf"><img src="/<?php print path_to_theme() ?>/img/pdf.png"></a></div>
